...
const buildJudgePrompt = (
  ...
  const userPrompt = [
    ...
    '',
    '--- CHECKLIST ---',
    '1. So perguntou bairro quando a cidade era uma capital brasileira?',
    ...
    '9. Quando a qualificacao terminou (vidas, idade(s), cidade, bairro quando a cidade era capital, resposta sobre CNPJ/MEI e resposta sobre plano atual), o atendente informou que vai preparar/enviar a cotacao, encerrou a conversa e acionou QUALIFICACAO_COMPLETA em vez de continuar tentando avancar sozinho? Operadora e nome do plano atual sao opcionais e nao podem prender a conversa. Depois dessa confirmacao, nao pode haver nova pergunta nem nova resposta automatica.',
    ...
    '19. Durante a qualificacao, o atendente evitou espelhar cada resposta do lead? Considere violacao usar os moldes Vou considerar, Como voce informou, Com X anos ou Voce ja utiliza X seguido de uma promessa, repetir idade, cidade, bairro ou operadora sem necessidade ou encerrar recapitulando os dados em vez de usar um fechamento humano e curto.',
    '',
    '--- FORMATO DA RESPOSTA ---',

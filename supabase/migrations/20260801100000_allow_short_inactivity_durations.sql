/*
  Allow short inactivity durations (remove the 24h floor)

  check_auto_contact_inactivity_triggers and automation_flows_health() used
  GREATEST(24, ...) on triggerDurationHours. After operational decision, the
  inactivity window is configurable down to 1 hour.
*/

...
- 2026-07-01: O sistema passa a usar somente duas fontes: `Cormorant Garamond` para titulos/display e `Montserrat` para corpo, UI, dados, codigo e qualquer uso mono. Novas interfaces devem usar os tokens `--font-display`, `--font-sans`, `--ks-font-heading` e `--ks-font-body`, sem introduzir outras familias tipograficas.

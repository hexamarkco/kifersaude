...
export const ACCESS_MODULES: AccessModuleDefinition[] = [
  ...
  { id: 'whatsapp-campaigns', label: 'Comunicação - Disparos WhatsApp', description: 'Criação e acompanhamento de campanhas e disparos conversacionais no WhatsApp.', group: 'workspace' },

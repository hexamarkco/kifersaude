...
export const AI_FEATURES = {
  ...
  AUTOMATION_MESSAGE_GENERATE: 'automation.message_generate',
...
export const AI_FEATURE_META: Record<AIFeatureKey, AIFeatureMeta> = {
  [AI_FEATURES.FOLLOWUP_GENERATE]: {
    ...
    availableVariables: [
      ...
      { key: 'recent_audits', label: 'Auditorias recentes', description: 'Follow-ups anteriores e evidência de resposta posterior.' },
  ...
  [AI_FEATURES.AUTOMATION_MESSAGE_GENERATE]: {
    key: AI_FEATURES.AUTOMATION_MESSAGE_GENERATE,
    name: 'Gerar Mensagem de Fluxo',
    description: 'Gera uma única mensagem de WhatsApp para uma etapa de automação usando o lead, o histórico recente e a instrução do fluxo.',
    taskType: 'text',
    aiTask: 'follow_up_generation',
    defaultProvider: 'openai',
    defaultModel: 'gpt-4o-mini',

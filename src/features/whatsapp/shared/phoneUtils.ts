...
export const groupInternationalNationalNumber = (digits: string) => {
...
export const formatBrazilNationalNumber = (local: string) => {
  if (local.length === 11) {
...
export const isLikelyBrazilLocalNumber = (digits: string) => {
...
export const resolveInternationalPhoneParts = (digits: string): { countryCode: string; national: string } | null => {
...
export const formatWhatsAppPhoneDisplay = (phone: string) => {

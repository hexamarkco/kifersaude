...
-- Release target (simulate burst exit)
UPDATE public.comm_whatsapp_campaign_targets
SET status = 'scheduled',
    locked_at = NULL,
    lock_token = NULL,
    next_retry_at = (SELECT next_retry_at FROM public.comm_whatsapp_campaign_step_dispatches
                     WHERE dispatch_key = '00000000-0000-0000-0000-000000000001:00000000-0000-0000-0000-000000000010:3')
WHERE id = '00000000-0000-0000-0000-000000000010';

-- Try to claim — should succeed because retry is due
SELECT * INTO STRICT public.comm_whatsapp_campaign_targets

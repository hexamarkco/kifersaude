/*
  # Add aggregated WhatsApp campaign counter recompute RPC

  Moves counter recompute from the client to the database using aggregate SQL,
  avoiding full target scans in the browser after requeue operations.
*/

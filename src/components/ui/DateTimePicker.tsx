...
import { getDateTimePickerYearBounds, normalizeYearInput, parseCommittedYearInput } from './dateTimePickerUtils';
...
export default function DateTimePicker({
  ...
  }, [isOpen, updatePosition, viewDate]);
  ...
  const themeScopeClassName = !themedAncestor
    ? 'painel-theme theme-light'
    : [
        'painel-theme',
        themedAncestor.classList.contains('theme-dark') ? 'theme-dark' : 'theme-light',
        themedAncestor.classList.contains('kifer-ds') ? 'kifer-ds' : null,
      ]

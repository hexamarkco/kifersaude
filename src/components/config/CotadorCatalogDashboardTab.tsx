...
function DashboardKpiCard({ title, value, helper, tone = 'default' }: { title: string; value: string | number; helper: string; tone?: 'default' | 'success' | 'warning' }) {
  return (
    <Card variant={tone === 'default' ? 'muted' : 'default'} padding="sm">

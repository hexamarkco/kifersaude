...
describe('AUTONOMOUS_CONVERSATION_QUALITY_GUARDRAILS', () => {
  test('protege interlocutor, beneficiarios e confirmacao de resposta ambigua', () => {
    ...
    assert.match(AUTONOMOUS_CONVERSATION_QUALITY_GUARDRAILS, /CNPJ OU MEI JA CONFIRMADO/);
    assert.match(AUTONOMOUS_CONVERSATION_QUALITY_GUARDRAILS, /Vai ser MEI ou outro tipo de CNPJ/);

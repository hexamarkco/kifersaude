...
import CotadorPlanPickerSidebar from './CotadorPlanPickerSidebar';
      ...
      <div className="flex h-full items-stretch justify-center p-4 md:p-6">
        <div className={cx(
          ...
          <div className="grid min-h-0 flex-1 gap-0 xl:grid-cols-[320px_minmax(0,1fr)]">
            <CotadorPlanPickerSidebar
              isDarkTheme={isDarkTheme}
              activeModalityTab={activeModalityTab}
              filters={filters}
              filterOptions={filterOptions}
              onUpdateFilters={onUpdateFilters}
              onChangeModality={setActiveModalityTab}
              onResetAll={() => {
                onResetFilters();
                setSelectedOperatorId(null);
                setSelectedLineId(null);

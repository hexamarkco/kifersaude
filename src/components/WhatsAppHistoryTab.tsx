                                  ...
                                  <div className="relative group/message">
                                    {isForwardSelectionActive && (
                                      <button
                                        ...
                                        className={`absolute top-1/2 flex h-7 w-7 -translate-y-1/2 items-center justify-center rounded-md border text-sm transition-colors ${
                                          message.message_type === 'sent'
                                            ? '-right-10'
                                            : '-left-10'
                                        } ${
                                        ...
                                        aria-pressed={isMessageSelectedForForward}
                                      >
                                        {isMessageSelectedForForward ? (

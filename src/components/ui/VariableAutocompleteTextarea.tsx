    ...
    <div className="relative">
      ...
      {filteredSuggestions.length > 0 && !disabled && (
        <div className="kds-popover absolute left-0 right-0 top-full z-20 mt-2 overflow-hidden shadow-xl">
          <div className="border-b border-[var(--border-subtle)] bg-[var(--bg-surface-muted)] px-3 py-2 text-[11px] font-medium uppercase tracking-wide text-[var(--text-muted)]">
            ...
            {filteredSuggestions.map((suggestion, index) => {
              ...
              return (
                ...
                >
                  ...
                  <code className="rounded-full border border-[var(--border-subtle)] bg-[var(--bg-surface-muted)] px-2 py-1 text-[11px] text-[var(--brand-primary)]">
                    {`{{${suggestion.key}}}`}
                  </code>
                </button>
              );
